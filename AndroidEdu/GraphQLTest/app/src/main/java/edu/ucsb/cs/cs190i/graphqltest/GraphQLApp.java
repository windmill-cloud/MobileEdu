...
package edu.ucsb.cs.cs190i.graphqltest;
...
/**
 * Created by xuanwang on 4/20/17.
 */

public class GraphQLApp extends Application {
    ...
    @Override public void onCreate() {
        ...
        CacheKeyResolver<Map<String, Object>> cacheKeyResolver = new CacheKeyResolver<Map<String, Object>>() {
            @Nonnull
            @Override public CacheKey resolve(@Nonnull Map<String, Object> objectSource) {
